...
type FunctionData = (Set.Set Name, Set.Set Identifier, Set.Set Name, Set.Set Name, Set.Set Name)

type Metadata = Map.Map Identifier FunctionData
...
update :: (FunctionData -> FunctionData) -> Metadata -> Collector Metadata
update f m = do
    env <- ask
    case env of
        (Nothing, _) -> pure m
...
hasArgs :: Set.Set Identifier -> Metadata -> Collector Metadata
...
type ClosureData = Map.Map Identifier (Set.Set Name, Set.Set Identifier, Set.Set Name, Set.Set Name)
